...
-- Créer la base de données avec le jeu de caractères latin1 et la collation latin1_swedish_ci
CREATE DATABASE IF NOT EXISTS `network_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `network_db`;

-- Liste de configuration pour assurer la compatibilité (ces lignes sont facultatives)
 /*!40101 SET @OLD_CHARACTER_SET_CLIENT=@@CHARACTER_SET_CLIENT */;
 /*!40101 SET NAMES utf8 */;
 /*!50503 SET NAMES utf8mb4 */;
 /*!40103 SET @OLD_TIME_ZONE=@@TIME_ZONE */;
...
-- Insertion des données dans scan_results
INSERT INTO `scan_results` (`id`, `ip`, `hostname`, `status`, `open_ports`, `scan_time`) VALUES
	(49, '192.168.1.5', 'DESKTOP-M333S0L', 'up', '', '2025-02-25 11:22:01'),
	(50, '192.168.1.36', 'DESKTOP-M333S0L', 'up', '', '2025-02-25 11:22:01'),
	(51, '192.168.1.254', 'DESKTOP-M333S0L', 'up', '53, 80, 443, 445, 554', '2025-02-25 12:08:51'),
